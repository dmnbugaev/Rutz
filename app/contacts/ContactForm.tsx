  ...
  if (status === 'success') {
    return (
      <div className="border border-border p-8 text-center space-y-4">
        <div className="w-12 h-12 border border-foreground flex items-center justify-center mx-auto text-xl">
          ✓
        </div>
    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      <div>
        ...
        <input
          ...
          className="w-full border border-border bg-background px-4 py-3 text-sm placeholder:text-muted-foreground focus:outline-none focus:border-foreground transition-luxury"
        />
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full border border-border bg-background px-4 py-3 text-sm placeholder:text-muted-foreground focus:outline-none focus:border-foreground transition-luxury resize-none"
        />
      </div>
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-2 bg-foreground text-background py-4 text-xs uppercase tracking-luxury transition-luxury hover:bg-foreground/80 disabled:opacity-60"
      >
